...
unsafe fn isabelle_bullet_fair(fighter: &mut L2CAgentBase) {
...
unsafe fn isabelle_bullet_bair(fighter: &mut L2CAgentBase) {
    if macros::is_excute(fighter) {
...
unsafe fn isabelle_clayrocket_fly(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    smashline::install_acmd_scripts!(
        isabelle_bullet_fair,
        isabelle_bullet_bair,
        isabelle_clayrocket_fly,
    );
}